...
from app.api import auth, users, rounds, agents, leaderboard, market_data, trades
...
app.include_router(leaderboard.router, prefix="/api", tags=["Global Leaderboard"])  # For global endpoints
